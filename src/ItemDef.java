    ...
    public static ItemDef forID(int i) {
        ...
        switch (itemDef.id) {
            ...
            case 1189:
                ...
                itemDef.description = "The kiteshield of a victorious warrior.".getBytes();
                break;
            /**
             * Primal platebody.
             */
            case 1117:
                ...
                itemDef.description = "The platebody of a victorious warrior.".getBytes();
                break;
            /**
             * Primal fullhelm.
             */
            case 1155:
                ...
                itemDef.description = "The helmet of the most victorious warrior.".getBytes();
                break;
            /**
             * Primal platelegs.
             */
            case 1075:
                ...
                itemDef.description = "A victorious warrior's plateslegs.".getBytes();
                break;
            /**
             * Primal plateskirt.
             */
            case 1087:
                ...
                itemDef.description = "A victorious warrior's plateskirt.".getBytes();
                break;
            /**
             * Primal gloves.
             */
            case 13035:
                ...
                itemDef.description = "A victorious warrior's hand guards.".getBytes();
                break;
            /**
             * Primal boots.
             */
            case 13036:
                ...
                itemDef.description = "Maybe these could crush my feet, they're too heavy...".getBytes();
                break;
            ...
            case 13300:
                ...
                itemDef.description = "It's a Abyssal titan pouch.".getBytes();
                break;

            case 13301:
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Summon";
                itemDef.modelID = 3001;
                itemDef.modelZoom = 1049;
                itemDef.modelRotation1 = 545;
                itemDef.modelRotation2 = 1033;
                itemDef.modelOffset2 = 1;
                ...
                itemDef.description = "It's a Fire titan pouch.".getBytes();
                break;

            case 13302:
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Summon";
                itemDef.modelID = 3002;
                itemDef.modelZoom = 1049;
                itemDef.modelRotation1 = 545;
                itemDef.modelRotation2 = 1033;
                itemDef.modelOffset2 = 1;
                ...
                itemDef.description = "It's a Ice titan pouch.".getBytes();
                break;

            case 13303:
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Summon";
                itemDef.modelID = 3003;
                itemDef.modelZoom = 1049;
                itemDef.modelRotation1 = 545;
                itemDef.modelRotation2 = 1033;
                itemDef.modelOffset2 = 1;
                ...
                itemDef.description = "It's a Lava titan pouch.".getBytes();
                break;

            case 13304:
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Summon";
                itemDef.modelID = 3004;
                itemDef.modelZoom = 1049;
                itemDef.modelRotation1 = 545;
                itemDef.modelRotation2 = 1033;
                itemDef.modelOffset2 = 1;
                ...
                itemDef.description = "It's a Moss titan pouch.".getBytes();
                break;
            ...
            case 13306:
                ...
                itemDef.description = "It's a Steel titan pouch.".getBytes();
                break;
            case 13861:
            ...
            case 13896:
                ...
                break;
            case 13741:
                itemDef.name = "Devil Full helm";
                itemDef.actions = new String[5];
                itemDef.actions[1] = "Wear";
                itemDef.modelID = 30000;
                itemDef.modelZoom = 789;
                itemDef.modelRotation1 = 96;
                itemDef.modelRotation2 = 2039;
                itemDef.modelOffset2 = -7;
                itemDef.modelOffset1 = 2;
                itemDef.anInt204 = 0;
                itemDef.maleEquip1 = 30001;
                itemDef.femaleEquip1 = 30001;
                itemDef.description = "The helm of the devil him self.".getBytes();
                break;
            case 13902:
            ...
            case 13879:
                ...
                itemDef.description = "Morrigan's javelin.".getBytes();
                break;
            case 13883:
                ...
                itemDef.description = "Morrigan's throwing axe.".getBytes();
                break;
            case 13738:
                ...
                itemDef.description = "A spirit shield with a very powerful effect.".getBytes();//name
                break;
            case 13739:
                itemDef.actions = new String[5];//menu
                itemDef.actions[1] = "Wield";
                itemDef.modelID = 54496;//inventory/drop model
                itemDef.modelZoom = 1616;//Model Zoom
                itemDef.modelRotation1 = 396;//rotation 1
                itemDef.modelRotation2 = 1050;//rotation 2
                itemDef.modelOffset1 = -3;//model offset 1
                itemDef.modelOffset2 = 4;//model offset 2
                itemDef.maleEquip1 = 54496;//male wield ModelId
                itemDef.femaleEquip1 = 54496;//female wield ModelId
                itemDef.anInt188 = -1;//female sleeve
                itemDef.anInt164 = -1;//male sleeve
                itemDef.aByte154 = -10;
                itemDef.aByte205 = -10;
                itemDef.name = "Korasi's sword";//name
                itemDef.description = "The sword of a void knight.".getBytes();//name
                break;
            case 13744:
                itemDef.actions = new String[5];
                itemDef.actions[1] = "Wield";
                ...
                itemDef.description = "A spirit shield with a very powerful effect.".getBytes();
                break;
            case 13740:
                itemDef.actions = new String[5];//menu
                itemDef.actions[1] = "Wield";
