...
public final class EntityDef {
    ...
    public static EntityDef forID(int i) {
        ...
        if (i == 3000) { // NPC ID
            entityDef.actions = new String[5];
            entityDef.actions[1] = "Interact";
            entityDef.actions[2] = "Use special attack";
            entityDef.models = new int[1]; // Number of models the NPC uses
            int changedColors = 1; // Number of model colors changed on the NPC
            entityDef.models[0] = 3007; // Titan model id.
            entityDef.name = "Steel titan"; // NPC name
            entityDef.combatLevel = 230; //combat level
            entityDef.walkAnim = 0;
            entityDef.standAnim = 0;
            entityDef.aByte68 = 1;
            entityDef.description = "The king of the VarrockScape titans!".getBytes(); // NPC description
        }
